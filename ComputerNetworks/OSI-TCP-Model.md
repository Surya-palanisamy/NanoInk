...
6. Physical → Receives bits
7. Data Link → Reads MAC, removes header
8. Network → Reads IP, removes header
9. Transport → Reads port, reassembles
10. Application → Processes data
